  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-foreground data-active:border-border dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground",
